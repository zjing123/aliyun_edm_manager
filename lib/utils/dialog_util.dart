...
class _ReceiverDetailDialogState extends State<ReceiverDetailDialog> {
  final AliyunServiceManager _serviceManager = AliyunServiceManager();
  ...
  Future<void> _onCreate() async {
    ...
    try {
      ...
      final response = await _serviceManager.receiverService.saveReceiverDetail(widget.receiverId, receiverParams);
  ...
  Future<void> _onDelete(String email) async {
    ...
    try {
      await _serviceManager.receiverService.deleteReceiverDetail(widget.receiverId, email);
  ...
  Future<void> _loadData({bool isLoadMore = false}) async {
    ...
    try {
      final detail = await _serviceManager.receiverService.getReceiverDetail(
        widget.receiverId,
        keyWord: _searchController.text.trim(),
        pageSize: PaginationConstants.receiverDetailMaxPageSize,
