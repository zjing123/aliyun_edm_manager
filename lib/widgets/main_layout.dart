...
import 'package:aliyun_edm_manager/pages/receiver/receiver_list_page.dart';
import 'package:aliyun_edm_manager/pages/overview/overview_page.dart';
import 'package:aliyun_edm_manager/pages/sender/sender_address_list_page.dart';
import 'package:aliyun_edm_manager/pages/sender/sender_name_list_page.dart';
import 'package:aliyun_edm_manager/pages/template/template_list_page.dart';
import 'package:aliyun_edm_manager/pages/task/send_email/send_email_page.dart';
import 'package:aliyun_edm_manager/pages/task/scheduled_task/scheduled_email_task_list_page.dart';
import 'package:aliyun_edm_manager/pages/receiver/invalid_addresses_page.dart';
import 'package:aliyun_edm_manager/pages/sending_data_page.dart';
import 'package:aliyun_edm_manager/pages/sending_details_page.dart';
