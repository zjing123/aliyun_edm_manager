...
class _ReceiverDetailPageState extends State<ReceiverDetailPage> {
  ...
  Future<void> _onCreate() async {
    ...
    try {
      ...
      final response = await receiverService.saveReceiverDetail(widget.receiverId, receiverParams);
  ...
  Future<void> _onDelete(String email) async {
    ...
    try {
      ...
      final receiverService = _serviceManager!.receiverService;
      await receiverService.deleteReceiverDetail(widget.receiverId, email);
